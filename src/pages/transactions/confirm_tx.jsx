                ...
                <div className="space-y-3 mb-6">
                    {steps.map((step, index) => (
                        <div key={step} className="flex items-center gap-3">
                            <div className={`w-6 h-6 rounded-full flex items-center justify-center ${index < transactionStep ? 'bg-green-500' :
                            ...
                            <span className={`${index < transactionStep ? 'text-green-400' :
